...
![Captura del simulador MCO como BLUE, mostrando los paneles de parámetros del PGD, dispersión 3D con plano de regresión, dispersión 2D, histogramas de la distribución muestral de los coeficientes y el panel de coordenadas de los β̂ estimados](screenshot-simulador.png)
